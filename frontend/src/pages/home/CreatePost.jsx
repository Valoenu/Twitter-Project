...
import { toast } from "react-hot-toast"; // react-hot-toast -> Display messages
...
const CreatePost = () => {
  ...
  const handleSubmit = (e) => {
    // event with callback
    e.preventDefault(); // prevent natural web behaviour re-render
    createPost({ text, img });
  };
    ...
    <div className="flex p-4 items-start gap-4 border-b border-gray-700">
      ...
      <form className="flex flex-col gap-2 w-full" onSubmit={handleSubmit}>
        <textarea
          ...
          value={text}
          onChange={(e) => setText(e.target.value)} // event
        />
        {img && (
